...
export class ClothingComponent implements OnInit {
  ...
  filteredPrice(item : number){
    if(Number(this.price) < 20){
      this.price.push(item);
      console.log("Price 0-20 : "+ this.price);
    }
    if(Number(this.price) > 20 && Number(this.price) < 40){
      this.price.push(item);
      console.log("Price 20-40 : "+ this.price);
    }
    if(Number(this.price) > 40 && Number(this.price) < 60){
      this.price.push(item);
      console.log("Price 40-60 : "+ this.price);
    }
    if(Number(this.price) > 60){
      this.price.push(item);
      console.log("Price 60-80 : "+ this.price);
    }
  }
